...
3. На UEFI понадобится [EFI System Partition](https://wiki.archlinux.org/index.php/EFI_System_Partition). 512 MiB или больше
3. ???`/boot` лучше вынести в отдельный раздел. TODO: проверить
